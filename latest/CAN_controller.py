...
class CANController:
    def __init__(self, interface: str = "socketcan", channel: str = "can0"):
        ...
        self.session_token = [0x9D, 0xB2, 0x47, 0xF5]
        self.key_0x17_1 = [0x17, 0x01, 0x83, 0xE0, 0xE6, 0xE1]
        self.key_0x17_2 = [0x17, 0x01, 0x39, 0x9B, 0x45, 0x7F]
        self.key_0x19_1 = [0x19, 0x01, 0x83, 0xE0, 0xE6, 0xE1]
        self.key_0x19_2 = [0x19, 0x01, 0xD5, 0xD6, 0xED, 0x48]
